...
Бариста-бармен (без опыта) 
- от 18 лет
- график 5/2
- зарплата 60 000р (на руки) 
Стажировка и обучение оплачиваемое.
...
ADMIN_BROADCAST_USAGE = """Отправьте сообщение для рассылки:
- Просто текст для текстовой рассылки
- Фото с подписью (или без) для рассылки с картинкой
- Видео с подписью (или без) для рассылки с видео"""
